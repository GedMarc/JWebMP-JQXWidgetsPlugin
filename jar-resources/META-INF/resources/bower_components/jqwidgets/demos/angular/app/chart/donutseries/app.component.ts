...
export class AppComponent {
    ...
    dataAdapter_mobile: any = new jqx.dataAdapter(this.data_source_mobile, {
        async: false, autoBind: true, loadError: (xhr: any, status: any, error: any) => {
            alert('Error loading "' + this.data_source_mobile.url + '" : ' + error);
        }
    });
    ...
    dataAdapter_desktop: any = new jqx.dataAdapter(this.data_source_desktop, {
        async: false, autoBind: true, loadError: (xhr: any, status: any, error: any) => {
            alert('Error loading "' + this.data_source_desktop.url + '" : ' + error);
        }
    });
