 ...
 * @since 2013/01/16
 */
public class JQXCheckBoxFeature
		extends Feature<JQXCheckBoxOptions, JQXCheckBoxFeature>
		implements JQXCheckBoxFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXCheckBoxFeature that = (JQXCheckBoxFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxCheckBox(";
