...
public enum JQXDockingLayoutType
{
	...
	autoHideGroup,
	/**
	 * A panel that can be inserted in a tabbedGroup or autoHideGroup. When it is in a tabbedGroup it is represented by a ribbon item and in an autoHideGroup - by a jqxWindow-like
	 * panel inside a
	 * ribbon item.
	 */
	layoutPanel,
	...
	documentPanel,
	/**
	 * A floating group that can contain a tabbedGroup or a layoutPanel. It is represented by a jqxWindow. Initial floatGroups have to be defined after the root layoutGroup in the
	 * layout array.
	 */
	floatGroup,;
