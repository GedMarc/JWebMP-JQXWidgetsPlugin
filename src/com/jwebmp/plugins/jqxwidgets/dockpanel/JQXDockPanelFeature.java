 ...
 * @since 2013/01/16
 */
public class JQXDockPanelFeature
		extends Feature<JQXDockPanelOptions, JQXDockPanelFeature>
		implements JQXDockPanelFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXDockPanelFeature that = (JQXDockPanelFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxDockPanel(";
