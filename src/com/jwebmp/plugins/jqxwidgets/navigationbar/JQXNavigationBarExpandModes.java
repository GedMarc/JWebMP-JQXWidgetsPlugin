...
public enum JQXNavigationBarExpandModes
{
	...
	single,
	/**
	 * only one item can be expanded. If the expanded item's height is greater than the value of the height property, a vertical scrollbar is shown inside the content of the
	 * expanded item
	 */
	singleFitHeight,
	/**
	...
	multiple,
	/**
	 * only one item can be expanded. The expanded item can also be collapsed.If the expanded item's height is greater than the value of the height property, a vertical scrollbar
	 * is shown
	 */
	toggle,
	/**
