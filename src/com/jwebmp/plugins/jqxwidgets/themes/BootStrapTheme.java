		...
		extends Theme
{
	...
	public BootStrapTheme()
	{
		...
		getCssReferences().add(new CSSReference("JQXbootstrapTheme", 3.91, "bower_components/jqwidgets/jqwidgets/styles/jqx.bootstrap.css",
		                                        "https://jqwidgets.com/public/jqwidgets/styles/jqx.bootstrap.css"));
