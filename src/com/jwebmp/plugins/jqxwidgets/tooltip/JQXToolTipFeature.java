 ...
 * @since 2013/01/16
 */
public class JQXToolTipFeature
		extends Feature<JQXToolTipOptions, JQXToolTipFeature>
		implements JQXToolTipFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXToolTipFeature that = (JQXToolTipFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxTooltip(";
