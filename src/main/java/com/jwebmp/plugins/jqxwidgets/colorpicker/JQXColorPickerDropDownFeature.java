 ...
 * @since 2013/01/16
 */
public class JQXColorPickerDropDownFeature
		extends Feature<JQXColorPickerOptions, JQXColorPickerDropDownFeature>
		implements JQXColorPickerFeatures, GlobalFeatures
{
