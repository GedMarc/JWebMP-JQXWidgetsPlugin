 ...
 * @since 14 Dec 2015
 */
public class JQXDockingLayoutArray
		extends JavaScriptPart
{
	 ...
	 * 'autoHideGroup' - a group that contains layoutPanels. It is represented by a jqxRibbon with mode: 'popup'. Each ribbon item has a jqxWindow-like panel in its content. This
	 * group has to be
	 * either the first or the last child item of its parent layoutGroup.
	 * 'layoutPanel' - a panel that can be inserted in a tabbedGroup or autoHideGroup. When it is in a tabbedGroup it is represented by a ribbon item and in an autoHideGroup - by a
	 * jqxWindow-like
	 ...
	 * 'floatGroup' - a floating group that can contain a tabbedGroup or a layoutPanel. It is represented by a jqxWindow. Initial floatGroups have to be defined after the root
	 * layoutGroup in the
	 * layout array.
	 */
	...
	/**
	 * sets the height of a group (N/A to panels). Used only if the parent group's orientation is 'vertical' or for floatGroups. The heights of all such groups have to be set
	 * either in pixels or
	...
	/**
	 * sets the width of a group (N/A to panels). Used only if the parent group's orientation is 'horizontal' or for floatGroups. The widths of all such groups have to be set
	 * either in pixels or
	 * percents (not a mix of both).
	 */
