 ...
 * @since 2013/01/16
 */
public class JQXDockingLayoutFeature
		extends Feature<JQXDockingLayoutOptions, JQXDockingLayoutFeature>
		implements JQXDockingLayoutFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXDockingLayoutFeature that = (JQXDockingLayoutFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxDockingLayout(";
