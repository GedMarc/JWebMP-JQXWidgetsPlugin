 ...
 */
package com.jwebmp.plugins.jqxwidgets.expander;
 ...
 * @since 2013/01/16
 */
public class JQXExpanderFeature
		extends Feature<JQXExpanderOptions, JQXExpanderFeature>
		implements JQXExpanderFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXExpanderFeature that = (JQXExpanderFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxExpander(";
