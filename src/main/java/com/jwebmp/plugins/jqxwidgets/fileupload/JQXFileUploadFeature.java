 ...
 * @since 2013/01/16
 */
public class JQXFileUploadFeature
		extends Feature<JQXFileUploadOptions, JQXFileUploadFeature>
		implements JQXFileUploadFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXFileUploadFeature that = (JQXFileUploadFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxFileUpload(";
