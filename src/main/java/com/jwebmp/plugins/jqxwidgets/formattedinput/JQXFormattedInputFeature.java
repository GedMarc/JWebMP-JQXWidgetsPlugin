 ...
 * @since 2013/01/16
 */
public class JQXFormattedInputFeature
		extends Feature<JQXFormattedInputOptions, JQXFormattedInputFeature>
		implements JQXFormattedInputFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXFormattedInputFeature that = (JQXFormattedInputFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxFormattedInput(";
