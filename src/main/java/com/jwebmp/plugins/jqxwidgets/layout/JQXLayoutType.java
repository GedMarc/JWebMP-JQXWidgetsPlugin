...
public enum JQXLayoutType
{
	...
	documentGroup,
	/**
	 * a group that contains layoutPanels. It is represented by a jqxRibbon with mode: popup. Each ribbon item has a jqxWindow-like panel in its content. This group has to be
