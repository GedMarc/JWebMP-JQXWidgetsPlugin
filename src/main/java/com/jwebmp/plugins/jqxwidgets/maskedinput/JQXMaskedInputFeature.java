 ...
 * @since 2013/01/16
 */
public class JQXMaskedInputFeature
		extends Feature<JQXMaskedInputOptions, JQXMaskedInputFeature>
		implements JQXMaskedInputFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXMaskedInputFeature that = (JQXMaskedInputFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxMaskedInputssss(";
