 ...
 * @since 2013/01/16
 */
public class JQXNavBarFeature
		extends Feature<JQXNavBarOptions, JQXNavBarFeature>
		implements JQXNavBarFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof JQXNavBarFeature))
		{
			return false;
		}
		if (!super.equals(o))
		...
		JQXNavBarFeature that = (JQXNavBarFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxNavBar(";
