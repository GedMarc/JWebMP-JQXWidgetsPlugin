 ...
 * has weight value
 * which corresponds to its popularity, importance or recurrence on the page. The keywords in the cloud can have their own URL which navigates to a collection of items associated
 * with the relevant
 * tag. The user can easily customize the appearance of the control, choose the items that will be displayed in the cloud, their font size and color, sort the tags alphabetically
 * or by value, in
