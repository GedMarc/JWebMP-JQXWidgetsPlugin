		...
		extends JavaScriptPart
{
	...
	/**
	 * boolean property which determines whether the cells data wrapping is enabled. This property is set to true by default. When autoRowHeight is enabled and autoCellHeight is
	 * set to false, the
