 ...
 * @since 2013/01/16
 */
public class JQXValidatorFeature
		extends Feature<JQXValidatorOptions, JQXValidatorFeature>
		implements JQXValidatorFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXValidatorFeature that = (JQXValidatorFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxValidator(";
