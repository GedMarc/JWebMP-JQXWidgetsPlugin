 ...
 * @since 2013/01/16
 */
public class JQXWindowFeature
		extends Feature<JQXWindowOptions, JQXWindowFeature>
		implements JQXWindowFeatures, GlobalFeatures
{
	...
	public boolean equals(Object o)
	{
		...
		JQXWindowFeature that = (JQXWindowFeature) o;
	...
	{
		String requiredString = getComponent().getJQueryID() + "jqxWindow(";
