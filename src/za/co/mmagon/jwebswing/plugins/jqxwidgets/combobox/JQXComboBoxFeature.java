 ...
 * @since 2013/01/16
 */
public class JQXComboBoxFeature extends Feature<JQXComboBoxOptions, JQXComboBoxFeature> implements JQXComboBoxFeatures, GlobalFeatures
{
	...
	public JQXComboBoxOptions getOptions()
	{
		if (options == null)
		{
			options = new JQXComboBoxOptions();
		}
		return options;
	}
